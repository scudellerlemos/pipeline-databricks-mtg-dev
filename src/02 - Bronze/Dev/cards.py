...
# Uma mesma carta (mesmo id) pode aparecer em runs diferentes com dados
# diferentes (ex.: legalities mudou) - cada run preservado, sem dedup.
...
SCHEMA_NAME = "bronze"
BRONZE_TABLE_NAME = "cards"
STAGE_TABLE_NAME = "cards"
...
# EXECUCAO PRINCIPAL
# =============================================================================
cards_bronze_df, run = run_bronze_ingestion(
...
print("=" * 50)
print(f"RELATORIO DE INGESTAO BRONZE - CARDS")
print("=" * 50)
print(
    f"status={run['status']} "
