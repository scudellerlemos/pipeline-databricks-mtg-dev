...
# Camada Bronze - Migrations - Magic: The Gathering
...
# Historico de reconciliacao de scryfall_id (merge/delete) - preservado
# integralmente, sem filtro, para a Silver resolver IDs antigos se precisar.
...
SCHEMA_NAME = "bronze"
BRONZE_TABLE_NAME = "migrations"
STAGE_TABLE_NAME = "migrations"
...
# EXECUCAO PRINCIPAL
# =============================================================================
migrations_bronze_df, run = run_bronze_ingestion(
...
print("=" * 50)
print(f"RELATORIO DE INGESTAO BRONZE - MIGRATIONS")
print("=" * 50)
print(
    f"status={run['status']} "
